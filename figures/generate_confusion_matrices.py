...
def main():
    ...
    # Generate for LLaVA-1.5 on COCO-POPE (main result)
    model_key = 'llava15'
    ...
    plot_confusion_matrix(cm_baseline, 
                         f'Baseline - {model_name} on {dataset_name}',
                         'confusion_matrix_baseline_llava15_coco')
    
    plot_confusion_matrix(cm_combined, 
                         f'VCD+AGLA - {model_name} on {dataset_name}',
                         'confusion_matrix_combined_llava15_coco')
    ...
    # Generate error reduction plot
    plot_error_reduction(cm_baseline, cm_combined,
                        model_name, dataset_name,
                        'error_reduction_llava15_coco')
    
    # Generate for AOKVQA-POPE as well
    dataset_key = 'aokvqa_pope'
    dataset_name = 'AOKVQA-POPE'
    ...
    plot_confusion_comparison(cm_baseline, cm_combined, 
                            model_name, dataset_name,
                            'confusion_matrix_comparison_llava15_aokvqa')
